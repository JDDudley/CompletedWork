...
/**
 * Animates an object orbiting around the Earth.
 * Drawn with random color and theta 
 *
...
public class Orbit extends JPanel
{
	...
	public void paintComponent(Graphics g)
	{
		...
		// Calculate X & Y
		double thetaRadians = Math.toRadians(orbitTheta);
		double objectX = earthX - objectRadius + orbitRadius * Math.cos(thetaRadians);
		double objectY = earthY - objectRadius + orbitRadius * Math.sin(thetaRadians);
		g.fillOval((int) objectX, (int) objectY, objectRadius * 2, objectRadius * 2);
